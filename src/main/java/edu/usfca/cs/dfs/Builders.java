...
public class Builders {
   ...
   * @return heal request
   */
  public static StorageMessages.StorageMessageWrapper buildHealRequest(
      String fileName,
      long chunkId,
    ...
    StorageMessages.HealRequest healRequest =
        StorageMessages.HealRequest.newBuilder()
   ...
   * @return
   */
  public static StorageMessages.StorageMessageWrapper buildHealResponse(
      String filename, long chunkId, String passTo, ByteString data) {
    /* Store hostname in a JoinRequest protobuf */
    StorageMessages.HealResponse joinRequest =
   ...
   */
  public static StorageMessages.StorageMessageWrapper buildStoreRequest(
   ...
   * @return store chunk
   */
  public static StorageMessages.StorageMessageWrapper buildStoreChunk(
      String fileName, String primary, long id, long totalChunks, ByteString data) {
  ...
  /**
   * Builds a store response protobuf {@link edu.usfca.cs.dfs.StorageMessages.ReplicaAssignments}
   * {@link edu.usfca.cs.dfs.StorageMessages.StoreResponse} {@link
   * edu.usfca.cs.dfs.StorageMessages.StorageMessageWrapper}
   *
   * @param hostname
   * @return store response
   */
  public static StorageMessages.StorageMessageWrapper buildStoreResponse(
    ...
    return StorageMessages.StorageMessageWrapper.newBuilder()
  ...
  public static StorageMessages.StorageMessageWrapper buildRetrievalRequest(String fileName) {
    StorageMessages.RetrieveFile retrievalRequest =
        StorageMessages.RetrieveFile.newBuilder().setFileName(fileName).build();

    return StorageMessages.StorageMessageWrapper.newBuilder()
        .setRetrieveFile(retrievalRequest)
        .build();
  }
   ...
   * @return
   */
  public static StorageMessages.StorageMessageWrapper buildPossibleRetrievalHosts(
      String hosts, String fileName) {
    StorageMessages.PossibleRetrievalHosts hostsResponse =
        StorageMessages.PossibleRetrievalHosts.newBuilder()
            .setHosts(hosts)
            .setFileName(fileName)
            .build();

    return StorageMessages.StorageMessageWrapper.newBuilder()
        .setRetrievalHosts(hostsResponse)
        .build();
  }

  /**
   * @param downNodeHost
   * @param downNodeReplicaAssignment2
   * @return
   */
  public static StorageMessages.StorageMessageWrapper buildMergeReplicasOnFailure(
      String downNodeHost, String downNodeReplicaAssignment2) {

    StorageMessages.MergeReplicasOnFailure replicaRequest =
        StorageMessages.MergeReplicasOnFailure.newBuilder()
            .setDownNodeHostName(downNodeHost)
            .setReplicaAssignment2FromDownNode(downNodeReplicaAssignment2)
            .build();

    return StorageMessages.StorageMessageWrapper.newBuilder()
        .setMergeReplicasOnFailure(replicaRequest)
        .build();
  }
   ...
   * @return
   */
  public static StorageMessages.StorageMessageWrapper buildPrintRequest(
      ArrayList<StorageNodeContext> listOfNodes) {
    ...
    if (listOfNodes == null) {
      ...
      for (StorageNodeContext node : listOfNodes) {
        nodeState =
            StorageMessages.NodeState.newBuilder()
                .setDiskSpace(node.getFreeSpace())
   ...
   */
  public static StorageMessages.StorageMessageWrapper buildReplicaAssignments(
      String first, String second) {
    StorageMessages.ReplicaAssignments replicaAssignments =
        StorageMessages.ReplicaAssignments.newBuilder()
            .setReplica1(first)
            .setReplica2(second)
            .build();
    return StorageMessages.StorageMessageWrapper.newBuilder()
   ...
   */
  public static StorageMessages.StorageMessageWrapper buildReplicateToNewAssignment(
      String downNode, String newAssignment) {
    StorageMessages.ReplicateToNewAssignment replicateRequest =
        StorageMessages.ReplicateToNewAssignment.newBuilder()
            .setDownNode(downNode)
            .setNewAssignment(newAssignment)
            .build();

    return StorageMessages.StorageMessageWrapper.newBuilder()
        .setReplicateToNewAssignment(replicateRequest)
        .build();
  }
  ...
  public static StorageMessages.StorageMessageWrapper buildDeleteData(String downNode) {
    StorageMessages.DeleteData deleteRequest =
        StorageMessages.DeleteData.newBuilder().setDownNode(downNode).build();
   ...
   * @return
   */
  public static StorageMessages.StorageMessageWrapper buildSimplyMerge(
      String owner, String passedFrom) {
    StorageMessages.SimplyMerge simplyMerge =
        StorageMessages.SimplyMerge.newBuilder()
            .setOwner(owner)
            .setOwnershipPassedFrom(passedFrom)
            .build();
